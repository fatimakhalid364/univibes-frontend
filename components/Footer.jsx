        ...
        <section className={mainStyles.mainContainer}>
            <div className={mainStyles.bodyContainer}>
                ...
                <div className={mainStyles.linksContainer}>
                    <Link className={`link ${mainStyles.linkColor}`} href="#home">Home</Link>
                ...
                <div className={mainStyles.socialIcons}>
                    <Link href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                        <IconBrandFacebook size={24} className={mainStyles.icon} />
                    </Link>
                    <Link href="https://www.instagram.com" target="_blank" rel="noopener noreferrer">
                        <IconBrandInstagram size={24} className={mainStyles.icon} />
                    </Link>
                    <Link href="https://www.pinterest.com" target="_blank" rel="noopener noreferrer">
                        <IconBrandPinterest size={24} className={mainStyles.icon} />
                    </Link>
                    <Link href="https://www.twitter.com" target="_blank" rel="noopener noreferrer">
                        <IconBrandTwitter size={24} className={mainStyles.icon} />
                    </Link>
                </div>
