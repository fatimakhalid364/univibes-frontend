import mainStyles from '@/styles/testimonials.module.css';
            ...
            <div className={mainStyles.bodyContainer}>
                <div className={mainStyles.descContainer}>
                    <div className={mainStyles.headerContainer}>
                        ...
                        <h1 className={mainStyles.boldText}>What <span className={mainStyles.boldTextSpan}>Students</span> Say</h1>
